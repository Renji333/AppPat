        ...
        <script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/jquery.mmenu.lazysubmenus.js"></script>
        ...
        <?php if(is_single() && 'post' == get_post_type()) {
            echo "<script type='text/javascript' src='".get_stylesheet_directory_uri()."/js/jquery.mark.min.js'></script>";
